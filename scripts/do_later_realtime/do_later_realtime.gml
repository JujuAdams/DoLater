...
/// @param delay      Milliseconds to wait before executing the function, in frames. Values equal to or less than zero cause the function to be executed immediately
...
function do_later_realtime(_delay, _scope, _callback, _once)
{
